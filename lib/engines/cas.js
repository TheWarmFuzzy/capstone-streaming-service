...
cas_engine.pages.watch = function(page, options){
	...
	page = page.replace(/#watch_video_title#/,options.video_title);
	page = page.replace('#watch_video_description#',options.video_description);
	page = page.replace('#watch_video_privacy#',options.video_privacy);
	page = page.replace('#watch_video_category#',options.video_category);
	page = page.replace('#watch_video_language#',options.video_language);
	page = page.replace('#watch_video_rating#',options.video_rating);
	return page;
}
