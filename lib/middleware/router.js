...
function post_upload(req, res, next){
	...
	req.body.privacy = input_validator.integer(req.body.privacy,1,2);
	...
	var child = execFile('transcoder.bat', [file_path,dest_path], (error, stdout, stderr) => {
		...
		var procedure = {
			...
			//ATTENTION - Fix this
			"values":[new_video_id, req.authentication.user, req.body.title, req.body.description,req.body.privacy,req.body.category,req.body.language,req.body.rating] 
		};
